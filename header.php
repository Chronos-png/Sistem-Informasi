		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Sistem Pendukung Keputusan Rekomendasi Wisata Agro Menggunakan Metode AHP</h2>
				</div>
			</div>
		</div>
				...
				<div class="col-md-8 order-md-last">
					<div class="row">
						<div class="col-md-6 text-center">
							<a class="navbar-brand" href="index.html">Sistem informasi <span>Kelompok 2</span></a>
						</div>
	    ...
	    <div class="container-fluid">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav m-auto">
				...
				<li class="nav-item"><a href="login.php" class="nav-link">Login Admin</a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
